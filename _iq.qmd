...
# read data
file_path <- file.path(patient, csv)
...
```{epoxy, .data = subscale}
- {description} was {range}, {scale} = {score} [{ci_95}], {percentile} percentile.\n
- Premorbid estimate: subscale$`Cognitive Proficiency`, TOPF, above average (SS = 112).
